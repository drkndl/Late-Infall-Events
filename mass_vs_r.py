...
def main():
    ...
    folder = Path("../fargo3d/outputs/cloud_disk_it450_b01_cmass10_rotX45")     # Folder with the output files (BinAC2)
    ...
    ####################### Compare radial mass distribution for different impact parameters ########################
    ...
    ####################### Compare radial mass distribution for different inclinations ########################
