...
def main():
    ...
    # Path("F:/cloud_disk_it450_b01_cmass10_rotX45"), Path("F:/cloud_disk_it450_cmass10_rotX45"), Path("F:/cloud_disk_it450_b09_cmass10_rotX45")

    # Simulation data locally
    folders = [Path("F:/cloud_disk_it450_b01_rotX45"), Path("F:/cloud_disk_it450_rotX45"), Path("F:/cloud_disk_it450_b09_rotX45")] #, Path("F:/cloud_disk_it450_cmass10_Rout30_rotX45"), Path("F:/cloud_disk_it450_cmass10_Rout30_rotY45")] #, Path("F:/cloud_disk_it450_retro_rotX45"), Path("F:/cloud_disk_it450_retro_rotY45")]
    ...
    cloud_acc_eff_folder = {}          # Net cloud accretion efficiency(t) for all sims
    ...
    for f in folders:
        ...
        for i in range(0, it+1, N):     
            ...
            # Calculating LRL vectors, eccentricities and mass-weighted radial averages of eccentricities of the disk only
    ...
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_b/param_study_inc_avg_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches='tight')
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_b/param_study_twist_avg_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_b/param_study_Mcloudacc_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_b/param_study_cloudacceff_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_b/param_study_abs_Mcloudacc_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_b/param_study_abs_cloudacceff_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_b/param_study_whirl_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_b/param_study_absolute_twist_avg_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout()
    plt.savefig(f'paper_plots/nice_plots_b/param_study_clean_Mdot_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout()
    plt.savefig(f'paper_plots/nice_plots_b/param_study_inc_final_iter_vs_r_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout()
    plt.savefig(f'paper_plots/nice_plots_b/param_study_twist_final_iter_vs_r_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout()
    plt.savefig(f'paper_plots/nice_plots_b/param_study_absolute_twist_final_iter_vs_r_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout()
    plt.savefig(f'paper_plots/nice_plots_b/param_study_Mcumsum_final_iter_vs_r_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout()
    plt.savefig(f'paper_plots/nice_plots_b/param_study_dMcumdlogr_final_iter_vs_r_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend()
    ax.axvline(2, ls=":", lw=4, color="black")
    # ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False) 
    plt.tight_layout()
    plt.savefig(f'paper_plots/nice_plots_b/param_study_e_final_iter_vs_r_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    #     ax.set_ylim(26, 33)
        # ax.legend(loc='upper left', bbox_to_anchor=(1.05, 1), borderaxespad=0.)   # loc='upper left', 
    #     plt.tight_layout()
    #     plt.savefig(f'nice_plots_b/param_study_dMcumdlogr_it{t}.png', bbox_inches="tight")
    #     plt.close()
