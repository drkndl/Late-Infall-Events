...
def main():
    ...
    plt.tight_layout() 
    plt.savefig(f'nice_plots_b/param_study_inc_avg_vs_t_warp{warp_thresh}.png', bbox_inches='tight')
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout() 
    plt.savefig(f'nice_plots_b/param_study_twist_avg_vs_t_warp{warp_thresh}.png', bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout() 
    plt.savefig(f'nice_plots_b/param_study_Mcloudacc_vs_t_warp{warp_thresh}.png', bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout() 
    plt.savefig(f'nice_plots_b/param_study_cloudacceff_vs_t_warp{warp_thresh}.png', bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout() 
    plt.savefig(f'nice_plots_b/param_study_abs_Mcloudacc_vs_t_warp{warp_thresh}.png', bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout() 
    plt.savefig(f'nice_plots_b/param_study_abs_cloudacceff_vs_t_warp{warp_thresh}.png', bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout() 
    plt.savefig(f'nice_plots_b/param_study_whirl_vs_t_warp{warp_thresh}.png', bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout() 
    plt.savefig(f'nice_plots_b/param_study_absolute_twist_avg_vs_t_warp{warp_thresh}.png', bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout()
    plt.savefig(f'nice_plots_b/param_study_clean_Mdot_vs_t_warp{warp_thresh}.png', bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout()
    plt.savefig(f'nice_plots_b/param_study_inc_final_iter_vs_r_warp{warp_thresh}.png', bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout()
    plt.savefig(f'nice_plots_b/param_study_twist_final_iter_vs_r_warp{warp_thresh}.png', bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout()
    plt.savefig(f'nice_plots_b/param_study_absolute_twist_final_iter_vs_r_warp{warp_thresh}.png', bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout()
    plt.savefig(f'nice_plots_b/param_study_Mcumsum_final_iter_vs_r_warp{warp_thresh}.png', bbox_inches="tight")
    plt.show()
