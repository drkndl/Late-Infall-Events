...
# colours = clrs[[0, 2, 3]]
colours = ['crimson', 'royalblue', 'limegreen', 'darkorange', 'teal']
...
def main():
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=5, frameon=False) 
    plt.tight_layout()
    plt.savefig(f'nice_plots_cmass/param_study_e_final_iter_vs_r_warp{warp_thresh}.png')
    plt.show()
