...
def main():
    ...
    folders = [Path("F:/cloud_disk_it450_rotX45"), Path("F:/cloud_disk_it450_cmass5_rotX45"), Path("F:/cloud_disk_it450_cmass7_rotX45"), Path("F:/cloud_disk_it450_cmass10_rotX45"), Path("F:/cloud_disk_it450_cmass15_rotX45")] #, Path("../cloud_disk_it450_b01_cmass10_rotX45"), Path("../cloud_disk_it450_b09_rotX45"), Path("../cloud_disk_it450_b09_cmass10_rotX45")] #, Path("../cloud_disk_it450_cmass10_Rout30_rotX45"), Path("../cloud_disk_it450_cmass10_Rout30_rotY45")] #, Path("../cloud_disk_it450_retro_rotX45"), Path("../cloud_disk_it450_retro_rotY45")]
    ...
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_cmass/param_study_inc_avg_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_cmass/param_study_twist_avg_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_cmass/param_study_Mcloudacc_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_cmass/param_study_cloudacceff_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_cmass/param_study_abs_Mcloudacc_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_cmass/param_study_abs_cloudacceff_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_cmass/param_study_whirl_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False)
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_cmass/param_study_absolute_twist_avg_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False) 
    plt.tight_layout()
    plt.savefig(f'paper_plots/nice_plots_cmass/param_study_clean_Mdot_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False) 
    plt.tight_layout()
    plt.savefig(f'paper_plots/nice_plots_cmass/param_study_inc_final_iter_vs_r_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False) 
    plt.tight_layout()
    plt.savefig(f'paper_plots/nice_plots_cmass/param_study_twist_final_iter_vs_r_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False) 
    plt.tight_layout()
    plt.savefig(f'paper_plots/nice_plots_cmass/param_study_absolute_twist_final_iter_vs_r_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False) 
    plt.tight_layout()
    plt.savefig(f'paper_plots/nice_plots_cmass/param_study_Mcumsum_final_iter_vs_r_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False) 
    plt.tight_layout()
    plt.savefig(f'paper_plots/nice_plots_cmass/param_study_dMcumdlogr_final_iter_vs_r_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.1), ncol=3, frameon=False) 
    plt.tight_layout()
    plt.savefig(f'paper_plots/nice_plots_cmass/param_study_e_final_iter_vs_r_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
