...
def main():
    ...
    folder = Path("F:/cloud_disk_it450_cmass10_rotX45/")                        # Folder with the FARGO output files
    ...
    # plt.colorbar(surf, label='Angle')
    plt.tight_layout()
    plt.savefig(f'{fig_imgs}/warp_twist_evol_3D.pdf', dpi=300)
    plt.show()
