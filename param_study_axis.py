...
def main():
    ...
    folders = [Path("F:/cloud_disk_it450_rotX45"), Path("F:/cloud_disk_it450_rotY45")]
    ...
    folders_labels = {"cloud_disk_it450_rotX45": r"$i_X=45^\circ$",
    "cloud_disk_it450_rotY45": r"$i_Y=45^\circ$"}
    ...
    for key, value in disk_inc_avg_folder.items():
        ...
        if "rotX" in key:
            ...
            ls = "--" 
        ax.plot(allit_years, value, linestyle=ls, color='black', label=folders_labels[key])
        
    ax.set_xlabel(r"Time [kyr]")
    ax.set_ylabel(r"$\mathrm{\beta_{avg} [deg]}$")
    # ax.set_title(fr"Time Evolution of Average Inclinations $(\mathrm{{\rho \geq 10^{warp_thresh}}})$")
    ax.legend()
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_axis/param_study_inc_avg_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend()
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_axis/param_study_twist_avg_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend()
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_axis/param_study_Mcloudacc_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend()
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_axis/param_study_cloudacceff_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend()
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_axis/param_study_abs_Mcloudacc_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend()
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_axis/param_study_abs_cloudacceff_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    for key, value in disk_whirl_folder.items():
        ...
        if "rotX" in key:
            ...
            base = key.replace("rotY", "")
            ls = "--" 
        ax.plot(allit_years[5:], value[5:], linestyle=ls, color='black', label=folders_labels[key])
    ...
    ax.legend()
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_axis/param_study_whirl_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    for key, value in disk_twist_avg_folder.items():
        ...
        if "rotX" in key:
            ...
            base = key.replace("rotY", "")
            ls = "--" 
        ax.plot(allit_years, np.abs(value), linestyle=ls, color='black', label=folders_labels[key])
    ...
    ax.legend()
    plt.tight_layout() 
    plt.savefig(f'paper_plots/nice_plots_axis/param_study_absolute_twist_avg_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    for key, value in disk_Mdot_folder.items():
        ...
        if "rotX" in key:
            ...
            base = key.replace("rotY", "")
            ls = "--" 
        ax.plot(allit_years, np.log10(-value), linestyle=ls, color='black', label=folders_labels[key])
        
    ax.set_xlabel(r"Time [kyr]")
    ax.set_ylabel(r"$\mathrm{\log\dot{M}}$ [$M_\odot$/yr]")
    # ax.set_title(fr"Time Evolution of Mass Accretion Rate onto Star $(\mathrm{{\rho \geq 10^{warp_thresh}}})$")
    ax.legend() 
    plt.tight_layout()
    plt.savefig(f'paper_plots/nice_plots_axis/param_study_clean_Mdot_vs_t_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    for key, value in disk_inc_folder.items():
        ...
        if "rotX" in key:
            ...
            base = key.replace("rotY", "")
            ls = "--" 
        ax.plot(np.log10(domains["r"]/au)[:-1], value[-1, :], linestyle=ls, color='black', label=folders_labels[key])   # -1 corresponds to last iteration
    ...
    ax.legend() 
    plt.tight_layout()
    plt.savefig(f'paper_plots/nice_plots_axis/param_study_inc_final_iter_vs_r_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend() 
    plt.tight_layout()
    plt.savefig(f'paper_plots/nice_plots_axis/param_study_twist_final_iter_vs_r_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    for key, value in disk_twist_folder.items():
        ...
        if "rotX" in key:
            ...
            base = key.replace("rotY", "")
            ls = "--" 
        ax.plot(np.log10(domains["r"]/au)[:-1], np.abs(value[-1, :]), linestyle=ls, color='black', label=folders_labels[key])   # -1 corresponds to last iteration
    ...
    ax.legend() 
    plt.tight_layout()
    plt.savefig(f'paper_plots/nice_plots_axis/param_study_absolute_twist_final_iter_vs_r_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    for key, value in Mcumsum_folder.items():
        ...
        if "rotX" in key:
            ...
            base = key.replace("rotY", "")
            ls = "--" 
        ax.plot(np.log10(domains["r"]/au)[:-1], np.log10(value[-1, :]), linestyle=ls, color='black', label=folders_labels[key])   # -1 corresponds to last iteration
    ...
    ax.legend() 
    plt.tight_layout()
    plt.savefig(f'paper_plots/nice_plots_axis/param_study_Mcumsum_final_iter_vs_r_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    for key, value in dMcumdlogr_folder.items():
        ...
        if "rotX" in key:
            ...
            base = key.replace("rotY", "")
            ls = "--" 
        ax.plot(np.log10(domains["r"]/au)[:-2], value[-1, :], linestyle=ls, color='black', label=folders_labels[key])   # -1 corresponds to last iteration
    ...
    ax.legend() 
    plt.tight_layout()
    plt.savefig(f'paper_plots/nice_plots_axis/param_study_dMcumdlogr_final_iter_vs_r_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    ax.legend() 
    plt.tight_layout()
    plt.savefig(f'paper_plots/nice_plots_axis/param_study_e_final_iter_vs_r_warp{warp_thresh}.pdf', dpi=300, bbox_inches="tight")
    plt.show()
    ...
    # current_color_index = (current_color_index + 1) % len('black's)        
    # 'black' = 'black's[current_color_index]
    #         ax.plot(np.log10(domains["r"]/au)[:-2], value[t, :], linestyle=ls, color='black', label=folders_labels[key])   # -1 corresponds to last iteration
    ...
    #     ax.legend() 
    #     plt.tight_layout()
    #     plt.savefig(f'nice_plots_axis/param_study_dMcumdlogr_it{t}.png')
    #     plt.close()
